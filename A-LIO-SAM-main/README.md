...
Optimized and Specialized LIO-SAM. 

__1.Improvement on efficiency.__

All tests are conducted on an i7-8700 3.2GHz CPU.

Original:
<p align='center'>
    <img src="./config/doc/performance/Before.png" alt="drawing" width="800"/>
</p>

After Replacing FLANN with Nanoflann:
<p align='center'>
    <img src="./config/doc/performance/After.png" alt="drawing" width="800"/>
</p>

After Using Sparsely Sampled Residuals and Code-Level Optimization:
<p align='center'>
    <img src="./config/doc/performance/AfterSparseResidual.png" alt="drawing" width="800"/>
</p>

__2. No need for a 9-axis IMU any more.__

__3. Auto gravity alignment for a 6-axis IMU.__
...
- [ROS](http://wiki.ros.org/ROS/Installation)
  ```
  sudo apt-get install -y ros-<your-distro>-navigation
  sudo apt-get install -y ros-<your-distro>-robot-localization
  sudo apt-get install -y ros-<your-distro>-robot-state-publisher
  ```
...
## Sample datasets
  ...
  * The datasets below need the parameters to be configured. In these datasets, the point cloud topic is "points_raw." The IMU topic is "imu_correct," which gives the IMU data in ROS REP105 standard. Because no IMU transformation is needed for this dataset, the following configurations need to be changed to run this dataset successfully:
    ...
    - The "extrinsicRot" in "config/params.yaml" needs to be set as identity matrices.
